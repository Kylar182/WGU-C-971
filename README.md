...
I have also added Xamarin.Android.Support.v4 Library to the Android project because it's not actually possibly to run without it due to the restrictions of the Xam.Plugins.Notifier Library we were instructed to use.
